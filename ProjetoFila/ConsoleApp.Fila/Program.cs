...
using ConsoleApp.Fila.Exercicio;
...
internal class Program
{
    private static void Main(string[] args)
    {
        ...
        gerenciador.AdicionarTicket(new Ticket(3, "Pedido de atualização de HardWare", Prioridade.Baixa));
        gerenciador.AdicionarTicket(new Ticket(3, "Pedido de atualização de Serviço" , Prioridade.Baixa));
        gerenciador.AdicionarTicket(new Ticket(4, "Problema de performance no servidor", Prioridade.Alta));
        gerenciador.AdicionarTicket(new Ticket(4, "Problema de performance no Switch",   Prioridade.Alta));
        gerenciador.AdicionarTicket(new Ticket(4, "Problema de performance no HardWare", Prioridade.Alta));
